...
async function probarDeteccionAutomatica() {
    try {
        console.log('🧪 Probando detección automática de columnas...');
        
        const filePath = path.join(__dirname, 'test_coches_variados.xlsx');
        console.log('📁 Archivo a importar:', filePath);
        console.log('📋 Columnas en el archivo: PLACA, VIN, PINTURA, KILOMETRAJE, VEHICULO');
        ...
        console.log('\n🎯 PRUEBA COMPLETADA');
        console.log('La detección automática debería haber mapeado:');
        console.log('- PLACA → matricula');
        console.log('- VIN → chasis');
        console.log('- PINTURA → color');
        console.log('- KILOMETRAJE → kms');
